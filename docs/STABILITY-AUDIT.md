...
| S-3 | Extract pure render-helpers from popup.js into `src/render/*` (start: burndown, timesheet, alert-HTML, snapshot/restore) + unit tests | 3 | M | low | makes the bug-prone layer testable |
