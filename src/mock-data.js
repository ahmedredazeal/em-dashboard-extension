...
const MOCK_SPRINT = {
  ...
  stories:      STORIES,
  subtasks: [
    { key:'DEMO-5a', summary:'BE index migration', estimateHours:8, status:'Done', statusCategory:'done',
    ...
    { key:'DEMO-5b', summary:'BE Review', estimateHours:3, status:'In Progress', statusCategory:'indeterminate',
      assignee:'Sara Hassan', assigneeAccountId:'mock-acc-sara', priority:'High', points:0,
      type:'Sub-task', isSubtask:true, parentKey:'DEMO-5', dueDate:d(2), startDate:d(-1), rank:'0|i0004:b', labels:[] },
    { key:'DEMO-5c', summary:'QA load test', estimateHours:5, status:'To Do', statusCategory:'new',
      assignee:'Sara Hassan', assigneeAccountId:'mock-acc-sara', priority:'High', points:0,
      type:'Sub-task', isSubtask:true, parentKey:'DEMO-5', dueDate:d(1), startDate:d(-2), rank:'0|i0004:c', labels:[] },
    { key:'DEMO-7a', summary:'BE retry/backoff', estimateHours:6, status:'In Progress', statusCategory:'indeterminate',
    ...
    { key:'DEMO-7b', summary:'BE Review', estimateHours:3, status:'To Do', statusCategory:'new',
      assignee:'Ahmed Reda', assigneeAccountId:'mock-acc-ahmed', priority:'Medium', points:0,
      type:'Sub-task', isSubtask:true, parentKey:'DEMO-7', dueDate:d(3), startDate:d(1), rank:'0|i0006:b', labels:[] },
    { key:'DEMO-9a', summary:'BE push provider', estimateHours:7, status:'In Progress', statusCategory:'indeterminate',
    ...
    { key:'DEMO-9b', summary:'FE notification center', estimateHours:9, status:'To Do', statusCategory:'new',
      assignee:'Omar Farouk', assigneeAccountId:'mock-acc-omar', priority:'Medium', points:0,
      type:'Sub-task', isSubtask:true, parentKey:'DEMO-9', dueDate:d(5), startDate:d(2), rank:'0|i0008:b', labels:[] },
    // DEMO-1 (Auth service migration, done) — completed breakdown
    { key:'DEMO-1a', summary:'BE token schema', estimateHours:6, status:'Done', statusCategory:'done',
      assignee:'Ahmed Reda', assigneeAccountId:'mock-acc-ahmed', priority:'Highest', points:0,
      type:'Sub-task', isSubtask:true, parentKey:'DEMO-1', dueDate:d(-6), startDate:d(-8), rank:'0|i0000:a', labels:[] },
    { key:'DEMO-1b', summary:'BE session store', estimateHours:10, status:'Done', statusCategory:'done',
      assignee:'Ahmed Reda', assigneeAccountId:'mock-acc-ahmed', priority:'Highest', points:0,
      type:'Sub-task', isSubtask:true, parentKey:'DEMO-1', dueDate:d(-4), startDate:d(-6), rank:'0|i0000:b', labels:[] },
    { key:'DEMO-1c', summary:'QA cutover smoke test', estimateHours:4, status:'Done', statusCategory:'done',
      assignee:'Sara Hassan', assigneeAccountId:'mock-acc-sara', priority:'Highest', points:0,
      type:'Sub-task', isSubtask:true, parentKey:'DEMO-1', dueDate:d(-3), startDate:d(-4), rank:'0|i0000:c', labels:[] },
    // DEMO-2 (Payment gateway integration, done) — completed breakdown
    { key:'DEMO-2a', summary:'BE gateway SDK', estimateHours:8, status:'Done', statusCategory:'done',
      assignee:'Sara Hassan', assigneeAccountId:'mock-acc-sara', priority:'Highest', points:0,
      type:'Sub-task', isSubtask:true, parentKey:'DEMO-2', dueDate:d(-6), startDate:d(-8), rank:'0|i0001:a', labels:[] },
    { key:'DEMO-2b', summary:'POS charge/refund flow', estimateHours:12, status:'Done', statusCategory:'done',
      assignee:'Omar Farouk', assigneeAccountId:'mock-acc-omar', priority:'Highest', points:0,
      type:'Sub-task', isSubtask:true, parentKey:'DEMO-2', dueDate:d(-3), startDate:d(-6), rank:'0|i0001:b', labels:[] },
    { key:'DEMO-2c', summary:'QA PCI sign-off', estimateHours:5, status:'Done', statusCategory:'done',
      assignee:'Sara Hassan', assigneeAccountId:'mock-acc-sara', priority:'Highest', points:0,
      type:'Sub-task', isSubtask:true, parentKey:'DEMO-2', dueDate:d(-1), startDate:d(-3), rank:'0|i0001:c', labels:[] },
    // DEMO-8 (Mobile responsive fixes, in progress) — mixed-status breakdown
    { key:'DEMO-8a', summary:'FE breakpoint audit', estimateHours:5, status:'Done', statusCategory:'done',
      assignee:'Layla Mostafa', assigneeAccountId:'mock-acc-layla', priority:'Medium', points:0,
      type:'Sub-task', isSubtask:true, parentKey:'DEMO-8', dueDate:d(-1), startDate:d(-2), rank:'0|i0007:a', labels:[] },
    { key:'DEMO-8b', summary:'FE nav/table reflow', estimateHours:7, status:'In Progress', statusCategory:'indeterminate',
      assignee:'Layla Mostafa', assigneeAccountId:'mock-acc-layla', priority:'Medium', points:0,
      type:'Sub-task', isSubtask:true, parentKey:'DEMO-8', dueDate:d(2), startDate:d(0), rank:'0|i0007:b', labels:[] },
    { key:'DEMO-8c', summary:'QA cross-device', estimateHours:6, status:'To Do', statusCategory:'new',
      assignee:'Nour Khalil', assigneeAccountId:'mock-acc-nour', priority:'Medium', points:0,
      type:'Sub-task', isSubtask:true, parentKey:'DEMO-8', dueDate:d(4), startDate:d(2), rank:'0|i0007:c', labels:[] },
  ],
};
...
const SUPPORT_TICKETS = [
  ...
  { key:'SUP-3', summary:'Export CSV returns empty file',           status:'In Progress',  statusCategory:'indeterminate', labels:['BreachedSLA'],                   assignee:'Ahmed Reda',    assigneeAccountId:'mock-acc-ahmed', points:0 },
  ...
  { key:'SUP-7', summary:'Reports show incorrect date range',       status:'Open',         statusCategory:'new',          labels:['BreachedSLA'],                   assignee:'Ahmed Reda',    assigneeAccountId:'mock-acc-ahmed', points:0 },
