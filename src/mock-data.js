...
const MOCK_SPRINT = {
  ...
  subtasks: [
    ...
    { key:'DEMO-1a', summary:'Design new token schema', status:'Done', statusCategory:'done',
    ...
    { key:'DEMO-1b', summary:'Migrate session store', status:'Done', statusCategory:'done',
      assignee:'Ahmed Reda', assigneeAccountId:'mock-acc-ahmed', priority:'Highest', points:0,
      type:'Sub-task', isSubtask:true, parentKey:'DEMO-1', dueDate:d(-4), startDate:d(-6), rank:'0|i0000:b', labels:[] },
    { key:'DEMO-1c', summary:'Cut over + smoke test', status:'Done', statusCategory:'done',
    ...
    { key:'DEMO-2a', summary:'Gateway SDK spike', status:'Done', statusCategory:'done',
      assignee:'Sara Hassan', assigneeAccountId:'mock-acc-sara', priority:'Highest', points:0,
      type:'Sub-task', isSubtask:true, parentKey:'DEMO-2', dueDate:d(-6), startDate:d(-8), rank:'0|i0001:a', labels:[] },
    { key:'DEMO-2b', summary:'Implement charge + refund flow', status:'Done', statusCategory:'done',
    ...
    { key:'DEMO-2c', summary:'PCI review + sign-off', status:'Done', statusCategory:'done',
      assignee:'Sara Hassan', assigneeAccountId:'mock-acc-sara', priority:'Highest', points:0,
    ...
    { key:'DEMO-8a', summary:'Audit breakpoints on iOS/Android', status:'Done', statusCategory:'done',
    ...
    { key:'DEMO-8b', summary:'Fix nav + table reflow', status:'In Progress', statusCategory:'indeterminate',
      assignee:'Layla Mostafa', assigneeAccountId:'mock-acc-layla', priority:'Medium', points:0,
      type:'Sub-task', isSubtask:true, parentKey:'DEMO-8', dueDate:d(2), startDate:d(0), rank:'0|i0007:b', labels:[] },
    { key:'DEMO-8c', summary:'Cross-device QA pass', status:'To Do', statusCategory:'new',
